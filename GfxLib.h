...
//
//	Version 3 (02/11/2009) : portage de la bibliotheque sous une forme specifique (mais plus limitee) Windows uniquement
//
...
typedef enum {Inactivite, Affichage, Clavier, ClavierSpecial, Souris, BoutonSouris, Initialisation, Redimensionnement}
	EvenementGfx;
...
// Demarre l'envoi periodique de messages Affichage pour assurer un nombre
// d'images par secondes constant mais inferieur a 100
void demandeAnimation_ips(int imagesParSeconde);
