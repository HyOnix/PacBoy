...
void gestionEvenement(EvenementGfx evenement) {
          ...
          case Initialisation: {
                    ...
                    InitEntity(&fantomes[0], 1.5 * taille, 22.5 * taille, 4, 2,
                               1);
          ...
          case Affichage:
                    ...
                    if (start == 1) {
                              ...
                              if (fantomes[0].state != 0) {
                                        DrawFantome(fantomes[0].x,
                                                    fantomes[0].y, 50, 50, 255,
                                                    0, 0);
                                        if (stat.vul) {
                                                  DrawFantome(fantomes[0].x,
                                                              fantomes[0].y, 50,
          ...
          case BoutonSouris:
                    ...
                    case GaucheAppuye:
                              ...
                              if (start == 0) {
                                        ...
                                        // Bouton Play appuyé
                                        if (((abscisseSouris() >
                                              35 * LargeurFenetre / 100) &&
                                             (abscisseSouris() <
                                              65 * LargeurFenetre / 100)) &&
                                            ((ordonneeSouris() >
                                              32 * HauteurFenetre / 100) &&
                                             (ordonneeSouris() <
                                              40 * HauteurFenetre / 100))) {
                                                  start = 1;
                                        }

                                        // Bouton Quit appuyé
                                        if (((abscisseSouris() >
                                              60 * LargeurFenetre / 100) &&
                                             (abscisseSouris() <
                                              90 * LargeurFenetre / 100)) &&
                                            ((ordonneeSouris() >
                                              17 * HauteurFenetre / 100) &&
                                             (ordonneeSouris() <
                                              25 * HauteurFenetre / 100))) {
                                                  system("clear");
                                                  exit(0);
                                        }
                                        ...
                                        if (((abscisseSouris() >
                                              10 * LargeurFenetre / 100) &&
                                             (abscisseSouris() <
                                              40 * LargeurFenetre / 100)) &&
                                            ((ordonneeSouris() >
                                              17 * HauteurFenetre / 100) &&
                                             (ordonneeSouris() <
                                              25 * HauteurFenetre / 100))) {
                              ...
                              if (start == 2) {
                                        ...
                                        if (((abscisseSouris() >
                                             ...
                                             (abscisseSouris() <
                                              65 * LargeurFenetre / 100)) &&
                                            ((ordonneeSouris() >
                                              15 * HauteurFenetre / 100) &&
                                             (ordonneeSouris() <
                                              23 * HauteurFenetre / 100))) {
                                                  start = 0;
                                        }
                              }
                              ...
                              if (start == 1) {
                                        ...
                                        // Bouton Pause appuyé
                                        if (((abscisseSouris() >
                                              70 * LargeurFenetre / 100) &&
                                             (abscisseSouris() <
                                              90 * LargeurFenetre / 100)) &&
                                            ((ordonneeSouris() >
                                              90 * HauteurFenetre / 100) &&
                                             (ordonneeSouris() <
                                              95 * HauteurFenetre / 100))) {
                                                  start = 3;
                                        }
                              }
                              ...
                              if (start == 3) {
                                        ...
                                        if (((abscisseSouris() >
                                              30.5 * LargeurFenetre / 100) &&
                                             (abscisseSouris() <
                                              70.5 * LargeurFenetre / 100)) &&
                                            ((ordonneeSouris() >
                                              37 * HauteurFenetre / 100) &&
                                             (ordonneeSouris() <
                                              45 * HauteurFenetre / 100))) {
                                                  start = 1;
                                        }

                                        // Bouton Retour menu appuyé
                                        if (((abscisseSouris() >
                                              20.5 * LargeurFenetre / 100) &&
                                             (abscisseSouris() <
                                              80.5 * LargeurFenetre / 100)) &&
                                            ((ordonneeSouris() >
                                              57 * HauteurFenetre / 100) &&
                                             (ordonneeSouris() <
                                              65 * HauteurFenetre / 100))) {
                                                  start = 0;
                                        }
                              }
