...
void menu(int Largeur, int Hauteur)
{
  ...
  if (x >= 100)
  {
    fantomeDraw(12 * Largeur / 100, (75 * Hauteur / 100) - 5 * Largeur / 100,
                5 * Largeur / 100, 255, 20, 20);
  ...
  if (x >= 400)
  {
    fantomeDraw(12 * Largeur / 100, (68 * Hauteur / 100) - 5 * Largeur / 100,
                5 * Largeur / 100, 228, 139, 224);
  ...
  if (x >= 700)
  {
    fantomeDraw(12 * Largeur / 100, (61 * Hauteur / 100) - 5 * Largeur / 100,
                5 * Largeur / 100, 115, 202, 228);
  ...
  if (x >= 1000)
  {
    fantomeDraw(12 * Largeur / 100, (54 * Hauteur / 100) - 5 * Largeur / 100,
                5 * Largeur / 100, 255, 192, 27);
    epaisseurDeTrait(1);
  ...
  afficheChaine(" CHARACTER / NICKNAME", 5 * Largeur / 100, 17 * Largeur / 100,
